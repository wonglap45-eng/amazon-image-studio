...
ENV VITE_DEFAULT_IMAGE_API_KEY=__VITE_DEFAULT_IMAGE_API_KEY_PLACEHOLDER__
ENV VITE_DEFAULT_PLANNER_API_URL=__VITE_DEFAULT_PLANNER_API_URL_PLACEHOLDER__
ENV VITE_DEFAULT_PLANNER_API_KEY=__VITE_DEFAULT_PLANNER_API_KEY_PLACEHOLDER__
ENV VITE_DEFAULT_PLANNER_MODEL=__VITE_DEFAULT_PLANNER_MODEL_PLACEHOLDER__
ENV VITE_DEFAULT_IMAGE_MODEL=__VITE_DEFAULT_IMAGE_MODEL_PLACEHOLDER__
...
ENV DEFAULT_IMAGE_API_KEY=
ENV DEFAULT_PLANNER_API_URL=
ENV DEFAULT_PLANNER_API_KEY=
